...
import com.Course.Model.CheckAdapter;
...
public class CustomMultiChoiceDialog extends Dialog {
	...
	public static class Builder {
		...
		private boolean showSelectSingle;
		private boolean showSelectDouble;
		...
		public Builder setMultiChoiceItems(String[] items, boolean[] checkedItems,
				OnItemClickListener onItemClickListener, boolean showSelectAll, boolean showSelectSingle,
				boolean showSingleDouble) {
			this.isMultiChoice = true;
			this.items = items;
			this.checkedItems = checkedItems;
			this.onItemClickListener = onItemClickListener;
			this.showSelectAll = showSelectAll;
			this.showSelectSingle = showSelectSingle;
			this.showSelectDouble = showSingleDouble;
			return this;
		}
		...
		public CustomMultiChoiceDialog create() {
			...
			final CheckBox checkAll = (CheckBox) layout.findViewById(R.id.chk_selectall);
			final CheckBox checkSingle = (CheckBox) layout.findViewById(R.id.chk_select_single);
			final CheckBox checkDouble = (CheckBox) layout.findViewById(R.id.chk_select_double);
			...
			if (isMultiChoice == true) {
				...
				for (int i = 0; i < count; i++) {
					CheckBox itemCheckBox = (CheckBox) listView.getAdapter().getView(i, null, null)
				...
				if (showSelectAll) {
					...
					checkAll.setOnCheckedChangeListener(new OnCheckedChangeListener() {
						...
						public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
							...
							if (isChecked) {
								checkDouble.setClickable(false);
								checkSingle.setClickable(false);
								...
								checkDouble.setClickable(true);
								checkSingle.setClickable(true);
				...
				if (showSelectSingle) {
					...
					checkSingle.setOnCheckedChangeListener(new OnCheckedChangeListener() {
						...
						public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
							if (isChecked) {
					            ...
					            checkDouble.setClickable(false);
								// update the status of all checkbox to
								// checked
								if (count > 0) {
								  ...
								  checkAll.setClickable(true);
						            checkDouble.setClickable(true);
								// update the status of checkbox to
								// unchecked
								if (count > 0) {
									for (int i = 0; i < count; i += 2) {
										CheckBox itemCheckBox = (CheckBox) listView.getAdapter().getView(i, null, null)
				...
				if (showSelectDouble) {
					...
					checkDouble.setOnCheckedChangeListener(new OnCheckedChangeListener() {
